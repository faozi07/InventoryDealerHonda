...
public class DB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            Log.d("DataVehicle ", "onCreate: " + sql2);
            db.execSQL(sql);
            db.execSQL(sql2);
        } catch (Exception exp) {
            exp.printStackTrace();
    ...
    public void insertUser(String nik, String username, String password, String nama) {
        try {
            SQLiteDatabase db = getWritableDatabase();
            String sql = "INSERT INTO " + TABLE_NAME_USER + " (" +
                    NIK + ", " +
                    USERNAME + ", "+
                    PASSWORD + ", "+
                    NAME+") VALUES ('" +
    ...
    public void cekUser(String username) {
        ...
        if (cursor.moveToFirst()) {
            do {
                Register.isRegistered = cursor.getString(1) != null && username.equals(cursor.getString(1));
    ...
    public void login(String username, String password) {
        ...
        if (cursor.moveToFirst()) {
            do {
                StaticVars.isTerdaftar = cursor.getString(1) != null && username.equals(cursor.getString(1));
                StaticVars.username = cursor.getString(1);
