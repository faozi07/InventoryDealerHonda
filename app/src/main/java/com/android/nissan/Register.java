...
public class Register extends AppCompatActivity {
    ...
    EditText editNik, editUsername, editPassword, editNama;
    Button btnRegister;
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (editNama.getText().toString().equals("") || editPassword.getText().toString().equals("") ||
                        editNik.getText().toString().equals("") || editUsername.getText().toString().equals("")) {
                    Toast.makeText(Register.this, "Isi data dengan lengkap", Toast.LENGTH_LONG).show();
                } else {
                    DB.cekUser(editUsername.getText().toString());
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            if (isRegistered) {
                                ...
                                DB.insertUser(editNik.getText().toString(), editUsername.getText().toString(), editPassword.getText().toString(), editNama.getText().toString());
                            }
                        }
                    }, 2000);
                    new Handler().postDelayed(new Runnable() {
